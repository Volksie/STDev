...
class AppState_EditingVerticalStud : AppState
{
	#region Public data
	#endregion
    ...
    public AppState_EditingVerticalStud()
        : base(AppStateId.EditingVerticalStud)
	{
	}
    ...
    public override void OnSectionClick(GameObject go)
    {
        if (AppRoot.Porch.GetElement(go) != null)
        {
            ...
            foreach (GameObject ugo in AppRoot.Instance.mUIGroups[Constants.cMoveVerticalStud].UIGroup)
            {
    ...
    {		
        ...
        else if (controlName == Constants.cMoveVerticalStudDoneControl)
        {
            foreach (GameObject go in AppRoot.Instance.mUIGroups[Constants.cMoveVerticalStud].UIGroup)
            {
                go.SetActiveRecursively(false);
        ...
        else if (controlName == Constants.cStudPositionControl)
        {
